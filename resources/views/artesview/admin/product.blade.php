...
<div class="row">
  ...
  <a class="waves-effect waves-light btn modal-trigger" href="#modal1"><i class="material-icons dp48">add</i></a> </span>
  </div>
		  </div>
		    	  ...
		    	  <div class="row">
                    ...
                    <table class="responsive-table">
                    	...
                    	<tbody>
                    		...
                    		<tr>
                    			<td><img width="128px;" src="{{asset(''.$picture->thumbnail)}}" alt=""></td>
                    			<td>
                    				

      <a href="javascript:void(0);" onclick="(retirarImagen('{{$picture->id}}'))" > <i class="material-icons dp48">delete</i>  </a>
                    			</td>
                    		</tr>
                    		@endforeach
                    	</tbody>
